import { ItemsRoutingModule } from './component/items/item-routing.module';
...
import { QuizRoutingModule } from './component/quizzes/quiz-routing.module';
...
const routes: Routes = [
  ...
  { path:'items', loadChildren: ()=> import('./component/items/item-routing.module').then(m=> m.ItemsRoutingModule)},
...
//2. register routes
@NgModule({
  imports: [RouterModule.forRoot(routes), ProductRoutingModule, ItemsRoutingModule],
